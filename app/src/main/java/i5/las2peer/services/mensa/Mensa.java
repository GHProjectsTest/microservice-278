...
public class Mensa extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "278", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-278/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response getDishRatings(@PathParam("id") String id) {
    ...
    if(ratings_condition) {
      JSONObject ratings = new classes().new DishRating().toJSON();
